...
class OperadorDashboard:
    ...
    def create_header(self, parent):
        ...
        tk.Label(
            title_frame,
            text="Panel de Control - Operador",
            font=("Arial", 11),
            fg="#94a3b8",
            bg="#1e293b",
    ...
    def create_sidebar(self, parent):
        """Panel de navegación lateral simplificado para Operador"""
        ...
        # Botones de navegación simplificados para Operador
        nav_items = [
            ("📊", "Dashboard", "#3b82f6"),
            ("📋", "Historial", "#8b5cf6"),
            ("📁", "Cargar Excel", "#06b6d4"),
    ...
    def navigate(self, option):
        """Navegación entre secciones para Operador"""
    ...
    def cargar_excel(self):
        ...
        messagebox.showinfo("Cargar Excel", "Funcionalidad de carga de archivos Excel")
...
if __name__ == "__main__":
    ...
    root = tk.Tk()
    user_data = {"nombre": "OPERADOR PRINCIPAL", "role": "Operador del Sistema"}
    app = OperadorDashboard(root, user_data, dummy_logout)
    root.mainloop()
